...
class PessoaForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['chefe_familia'].queryset = Pessoa.objects.filter(categoria_id__in=[1,7,9,12,20,24,25,37,38,39,40,42,44,45,46,47,49,50,51,54,58,60,61,62,63,64,65,68,69,70])
        self.fields['chefe_familia'].help_text = "O conteúdo deste campo atualmente está limitado a membros."
